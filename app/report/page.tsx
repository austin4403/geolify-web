...
export default function ReportPage() {
  return (
    <div className="flex flex-col flex-1 p-6 space-y-6 max-w-5xl mx-auto w-full min-h-full pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl border border-zinc-800 bg-zinc-900/80 hover:bg-zinc-800 text-zinc-200 text-xs font-medium backdrop-blur-md transition-colors"
          >
          ...
          <button
            type="button"
            className="inline-flex items-center gap-2 px-3.5 py-2 rounded-xl bg-blue-600 hover:bg-blue-500 text-white text-xs font-medium shadow-md shadow-blue-600/20 transition-colors"
          >
      ...
      {/* Main Report Card */}
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 shadow-xl space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-950/60">
            ...
            <p className="text-lg font-bold text-amber-400 mt-1">Au (Gold) ~ 4.2 g/t</p>
          </div>
          <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-950/60">
            <span className="text-xs text-zinc-400">Total Core Depth Sampled</span>
            <p className="text-lg font-bold text-zinc-100 mt-1">1,480 meters</p>
          </div>
          <div className="p-4 rounded-xl border border-zinc-800 bg-zinc-950/60">
            <span className="text-xs text-zinc-400">Est. Deposit Valuation</span>
            <p className="text-lg font-bold text-emerald-400 mt-1">$2,450,000</p>
          </div>
        </div>
